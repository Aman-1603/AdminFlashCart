...
public class Promotion_Code_Fragment extends Fragment {
    ...
    public Promotion_Code_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_brand__promotion_, container, false);
